...
def smart_suggestions():
    ...
    try:
        ...
        for job in job_listings:
            ...
            # ✅ Use structured input to improve model comprehension
            job_text = f"""
            Job Title: {title}
            ...
            # Skip jobs that are completely empty
            ...
            print(f"Job: {title} - Score: {round(score * 100, 2)}%")

            # ✅ Lower threshold to include loosely relevant jobs too
            if score >= 0.02:
                ranked_jobs.append({
                    **job,
        ...
        return jsonify({ "suggestions": ranked_jobs })
